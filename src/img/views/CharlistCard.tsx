...
export default function CharlistCard({ data }: CharlistCardProps) {
  ...
  return (
    <HTML style={{ width: '1000px' }}>
      <DarkContainer>
        <UserHeader name={base.name} uid={uid} level={base.level} worldLevel={base.worldLevel} avatarUrl={data.headUrl} decoText='ROLE COLLECTION' />

        <Section title='练度统计' extra={`★5: ${star5.length} · ★4: ${star4.length} · 共 ${roles.length} 角色`}>
