...
const HELP_DATA = [
    {
        ...
        desc: '在执行查询之前请绑定账号',
        items: [
            { icon: fileUrl$2, name: '绑定特征码', desc: '绑定特征码', eg: 'mc绑定123456' },
            { icon: fileUrl$3, name: '切换特征码', desc: '切换绑定的账户', eg: 'mc切换123456', needCk: true },
            { icon: fileUrl$4, name: '删除特征码', desc: '删除特征码', eg: 'mc删除123456' },
            { icon: fileUrl$5, name: '查看特征码列表', desc: '查看或刷新特征码列表', eg: 'mc查看' }
        ]
    },
    {
        title: '库街区登录',
        desc: '在执行查询之前请库街区登录',
        items: [
            { icon: fileUrl$6, name: '登录页登录', desc: '推荐登录方式', eg: 'mc登录' },
            { icon: fileUrl$7, name: '添加token', desc: '绑定库街区token', eg: 'mc添加token tk,did' },
            { icon: fileUrl$8, name: '删除token', desc: '删除当前库街区CK', eg: 'mc删除token 123456' },
            { icon: fileUrl$9, name: '获取绑定的token', desc: '获取绑定的token', eg: 'mc获取token', needCk: true }
        ]
    },
    {
        title: '信息查询',
        desc: '在执行查询之前请绑定账号',
        items: [
            { icon: fileUrl$a, name: '体力', desc: '获取每日体力状态', eg: 'mc每日', needCk: true },
            { icon: fileUrl$b, name: '基本信息卡片', desc: '查询基本信息', eg: 'mc卡片', needCk: true },
            { icon: fileUrl$c, name: '查询角色面板', desc: '查询角色面板', eg: 'mc查询', needCk: true },
            { icon: fileUrl$d, name: '查询探索度', desc: '查询探索度', eg: 'mc探索度', needCk: true },
            { icon: fileUrl$e, name: '刷新面板', desc: '刷新面板数据', eg: 'mc刷新面板', needCk: true }
        ]
    },
    {
        title: '深塔查询',
        desc: '深塔数据查询',
        items: [
            { icon: fileUrl$f, name: '深塔', desc: '查询逆境深塔', eg: 'mc深塔', needCk: true },
            { icon: fileUrl$g, name: '全息战略', desc: '查询全息战略', eg: 'mc全息战略', needCk: true },
            { icon: fileUrl$h, name: '冥歌海墟', desc: '查询冥歌海墟', eg: 'mc冥海', needCk: true },
            { icon: fileUrl$i, name: '终焉矩阵', desc: '查询终焉矩阵', eg: 'mc矩阵', needCk: true }
        ]
    },
    {
        title: '数据统计',
        ...
        items: [
            ...
            { icon: fileUrl$n, name: '抽卡记录', desc: '查询抽卡记录', eg: 'mc抽卡记录', needCk: true },
    ...
    },
    {
        ...
        desc: '签到与活动',
        items: [
            { icon: fileUrl$r, name: '签到', desc: '执行库街区每日签到', eg: 'mc签到', needCk: true },
            { icon: fileUrl$s, name: '签到日历', desc: '查看签到日历和奖励', eg: 'mc签到日历', needCk: true },
            ...
            { icon: fileUrl$y, name: 'Wiki攻略', desc: '角色技能/共鸣链/攻略', eg: 'mc安可攻略', needCk: true },
